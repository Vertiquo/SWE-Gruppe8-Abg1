...
."MonitorGetController" für Lesezugriffe an der REST-Schnittstelle
[plantuml,MonitorGetController,svg]
----
include::MonitorGetController.plantuml[]
----

Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem. Donec
sollicitudin molestie malesuada.

."MonitorWriteController" für Schreibzugriffe an der REST-Schnittstelle
[plantuml,MonitorGetController,svg]
----
include::MonitorWriteController.plantuml[]
----
...
.MonitorQueryResolver für Lesezugriffe an der GraphQL-Schnittstelle
[plantuml,MonitorQueryResolver,svg]
----
include::MonitorQueryResolver.plantuml[]
----

Donec sollicitudin molestie malesuada. Praesent sapien massa, convallis a
pellentesque nec, egestas non nisi.

.MonitorMutationResolver für Schreibzugriffe an der GraphQL-Schnittstelle
[plantuml,MonitorMutationResolver,svg]
----
include::MonitorMutationResolver.plantuml[]
----
...
."MonitorReadService" im Anwendungskern
[plantuml,MonitorReadService,svg]
----
include::MonitorReadService.plantuml[]
----

Pellentesque in ipsum id orci porta dapibus. Donec rutrum congue leo eget
malesuada.

."MonitorWriteService" im Anwendungskern
[plantuml,MonitorWriteService,svg]
----
include::MonitorWriteService.plantuml[]
----
...
.Entity
[plantuml,Monitor,svg]
----
include::Monitor.plantuml[]
----
