...
// nullish coalescing
const database = dbConfigEnv.name ?? Monitor.name.toLowerCase();
...
const username = dbConfigEnv.username ?? Monitor.name.toLowerCase();
...
export const typeOrmModuleOptions: TypeOrmModuleOptions =
    dbType === 'postgres'
        ? {
              ...
              password: pass,
              database,
              // siehe auch src\monitor\monitor.module.ts
              entities: [Monitor, Schlagwort],
