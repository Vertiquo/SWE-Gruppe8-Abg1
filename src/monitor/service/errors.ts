...
/**
 * Klasse für fehlerhafte Monitordaten. Die Meldungstexte sind in der Property
 * `msg` gekapselt.
 */
...
/**
 * Klasse für ein nicht-vorhandenes Monitor beim Ändern.
 */
export interface MonitorNotExists {
    readonly type: 'MonitorNotExists';
    readonly id: string | undefined;
}

/**
 * Union-Type für Fehler beim Ändern eines Monitores:
 * - {@linkcode MonitorNotExists}
 * - {@linkcode ConstraintViolations}
...
/**
 * Klasse, falls es mehrere Binärdateien zu einem Monitor gibt.
 */
...
/**
 * Union-Type für Fehler beim Lesen einer Binärdatei zu einem Monitor:
 * - {@linkcode MonitorNotExists}
